...
export const projects = [
  ...
  },
  {
    ...
    websiteUrl: "https://www.gasydia.com/",
    summary:
      "A React web experience for a car rental, driver, and guide service, with immersive travel content, galleries, and streamlined service discovery.",
    objective:
      "Modernize the original Spring Boot and Thymeleaf website as a responsive React application while preserving its visual identity, content, and routes.",
    year: "2026",
    label: "Client work",
    role: "React migration, frontend architecture, and performance optimization",
    stack: [
      "React",
      "TypeScript",
      "Vite",
    ...
    keyFeatures: [
      "Client-side routes for services, experiences, company information, contact, testimonials, and community work.",
      "Interactive travel carousels and image galleries with captions, thumbnails, counters, and zoom controls.",
      "Progressive Web App support with automatic service-worker updates and runtime image caching.",
      "Responsive image delivery with lazy loading, priority hints, and build-time optimization.",
    ],
    status: "Ongoing",
    statusDescription:
