    ...
    <main className="container pb-24 pt-20 sm:pt-28">
      ...
      <section className="mt-10 grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
        ...
        <div>
          ...
          <h1 className="mt-4 text-4xl font-medium tracking-[-0.05em] text-black dark:text-zinc-50 sm:text-5xl">
            {project.name}
          </h1>
          <p className="mt-6 max-w-3xl text-xl leading-8 text-black dark:text-zinc-300">
            {project.summary}
          </p>
